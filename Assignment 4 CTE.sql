...
-- I'll remove the payment_amount and payment_date columns from the payment table and replace them with a foreign key constraint referencing the payment_details table.
